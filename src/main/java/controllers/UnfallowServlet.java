...
@WebServlet(name = "UnfallowSerclet", value = "/unfollow")
public class UnfallowServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AppUser user2 = service.getUser(req.getParameter(ServletUtils.USER_LOGIN_TO_STOP_FOLLOW));
        service.unfallow(user1,user2);
